...
public class AdapterTransitionFragment extends Fragment implements Transition.TransitionListener {
     ...
     * AbsListView 為 ListView與GridVie的父類
     */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setHasOptionsMenu(true); //設定fragment是否要添加menu (true要顯示)
    }
    ...
    @Override
    public void onSaveInstanceState(Bundle outState) { //儲存
